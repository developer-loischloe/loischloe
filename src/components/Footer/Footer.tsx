            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex gap-3 items-center">
                <Link
                  ...
                  target="_blank"
                  aria-label="Facebook"
                  className="p-2 -m-1 hover:bg-white/10 rounded-full transition-colors"
                >
                  <svg
                ...
                <Link href="https://www.youtube.com/@loischloe" target="_blank" aria-label="YouTube" className="p-2 -m-1 hover:bg-white/10 rounded-full transition-colors">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
                ...
                >
                  <svg
                    ...
                    height="20"
                    fill="currentColor"
                    className="bi bi-instagram hover:fill-brand_primary transition-all"
                    viewBox="0 0 16 16"
                  >
